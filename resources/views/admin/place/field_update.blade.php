                ...
                <div class="">
                    ...
                    <div class="grid sm:grid-cols-4 grid-cols-1 gap-2">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input type="number" name="field_number" class="w-full" id="field_number" value="{{ $field->field_number }}"/>
                        </div>
                        <div class="mt-4">
                            <x-input-label class="uppercase" for="price_on_hour">Price on Hour<span class="text-rose-800">*</span></x-input-label>
                            <x-text-input type="number" name="price_on_hour" class="w-full" id="price_on_hour" value="{{ $field->price_on_hour }}"/>
                        </div>
                    </div>
